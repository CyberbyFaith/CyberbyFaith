...
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| **IT Security Team Lead**                  | Reviewed EDR alerts, analyzed system architecture, assessed third-party integrations, tracked vulnerabilities. |
| **CISO**                                   | Managed executive communication, evaluated breach indicators, assessed DRP/BCP activation requirements. |
| **Business Development Manager**           | Monitored customer trust impacts, evaluated reputational risk, supported merchant communications.       |
| **IT Manager**                             | Coordinated with vendor on update rollback, restored transaction services, addressed Shadow IT risks.   |
| **Incident Commander**                     | Directed IR team activities, maintained update cadence, evaluated contingency and continuity planning.  |
| **Government Relations Officer**           | Coordinated with federal/provincial agencies, ensured compliance, supported medication/service continuity. |
| **Communications Lead**                    | Aligned messaging with hospitals/government, managed internal and external crisis communications.       |
| **Canon (Industry Expert)**                | Provided technical diagnostics, performed onsite terminal support, forwarded backup/security alerts.     |
| **SailPoint (Identity Governance Expert)** | Reviewed privileged access, validated terminated employee deprovisioning, monitored identity lifecycle risk. |
