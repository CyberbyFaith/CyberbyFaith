...
- **Security Tools:** Wireshark, Nmap, Kali Linux, Metasploit, Burp Suite
- **Compliance:** HIPAA, NIST, ISO/IEC 27001, PCI-DSS, GDPR
- **Languages:** Python, SQL, Bash, HTML
- **Certifications:** Security+ (In Progress)
- **Soft Skills:** Critical thinking, detail-oriented, problem solving

---

## Interests ##
- IAM, Security Analysis, Incident Response, Risk assessments, Compliance
---
